...
for file_name in files:
    ...
    if "destination" in file_path:
        # densities_destination.append(
        #     nx.degree_assortativity_coefficient(graph))
        densities_destination.append(
            nx.degree_pearson_correlation_coefficient(graph))
    else:
        # densities_origin.append(nx.degree_assortativity_coefficient(graph))
        densities_origin.append(
            nx.degree_pearson_correlation_coefficient(graph))
...
plt.savefig("images/pearson-origin.png")
...
plt.ylabel("Density")
plt.xlabel("Combination")
plt.savefig("images/pearson-destination.png")
